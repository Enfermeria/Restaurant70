...
public class Recepcion extends javax.swing.JFrame implements Observer {
	...
	public Recepcion(Servicio recepcionista) {
		...
		System.out.println("llamando a initComponents");
		//initComponents();
		System.out.println("saliendo de initComponents");
		
		System.out.println("Inicializando modeloTablaMesas");
		modeloTablaMesas   = (DefaultTableModel) tablaMesas.getModel();
		System.out.println("modeloTablaMesas en constructor: " + modeloTablaMesas);
	...
	private void cargarMesas(){
		...
		List<Mesa> listaMesas = mesaData.getListaMesasXCriterioDeBusqueda(
				-1, -1, null, -1, MesaData.OrdenacionMesa.PORIDMESA);//ordenacion);
		
		System.out.println("LIstaMesas: " + listaMesas);
		...
		System.out.println("modeloTablaMesas: "+ modeloTablaMesas);
		int cantfilasmodelo = modeloTablaMesas.getRowCount();
		System.out.println("Cant filas modelo: " + cantfilasmodelo);
    ...
    private void initComponents() {
        ...
        cbOrden.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "por Id Mesa", "por Capacidad", "por Estado" }));
        cbOrden.setBorder(javax.swing.BorderFactory.createTitledBorder("Ordenar"));
        cbOrden.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                cbOrdenPropertyChange(evt);
            }
        });
    ...
    private void cbOrdenPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cbOrdenPropertyChange
		actualizarPantalla();
    }//GEN-LAST:event_cbOrdenPropertyChange
